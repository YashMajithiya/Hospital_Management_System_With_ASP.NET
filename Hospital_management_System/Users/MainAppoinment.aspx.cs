...
namespace Hospital_management_System.Users
{
    public partial class WebForm9 : System.Web.UI.Page
    {
        ...
        protected void btn_main_appointment_Submit_Click(object sender, EventArgs e)
        {
            ...
            {
                con.Open();
                string str = "insert into AppontTab(AID,Section,Name,Gender,Mobile,Email,Date) values("+lbl_Appontment_no.Text+",'"+ DropDownList_Section.SelectedItem.Text + "','"+txt_Appoint_name.Text+"','"+ DropDownList_gender.SelectedItem.Text+ "',"+txt_Apoint_Mobile.Text+",'"+txt_Apoint_Email.Text+"','"+datepicke.Text+"')";
